...
@implementation RACGetInternetQueryEngine
...
- (NSMutableURLRequest *)prepareMutableUrlRequest:(NSError *__autoreleasing *)error {
    ...
    return [self.sessionManager.requestSerializer requestWithMethod:@"GET" URLString:internetQuery.serverUrl parameters:parameters error:nil];
}
