...
- (UIBezierPath *)layoutPath {
    ...
    UIBezierPath *bezier = [UIBezierPath bezierPathWithArcCenter:CGPointMake(width/2.0f, width/2.0f)
...
- (void)animateFrame:(CADisplayLink *)displayLink {
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
        ...
        self.progress = self.fromProgress + d * (self.toProgress - self.fromProgress);
